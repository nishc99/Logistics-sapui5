		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Task Page",
									"targetURL": "#comexampletask1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexampletask1-display": {
								"semanticObject": "comexampletask1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.task1",
									"url": sap.ui.require.toUrl("com/example/task1")
								}
							}
						}
					}
